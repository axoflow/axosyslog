...
bool
AzureMonitorAuthenticator::send_token_get_request(std::string &response_payload_buffer)
{
  CURLcode ret;
  ...
  if (!hnd)
    {
      msg_error("cloud_auth::azure_monitor::AzureMonitorAuthenticator: "
  ...
  switch (self->auth_mode)
    ...
    case AAAM_MONITOR:
      try
        ...
        {
          msg_error("cloud_auth::azure_monitor: Failed to initialize AzureMonitorAuthenticator",
