...
afinet_dd_new_instance(TransportMapper *transport_mapper, gchar *hostname, const gchar *driver_name, GlobalConfig *cfg)
{
...
{
  return afinet_dd_new_instance(transport_mapper_tcp_new(), host, "afsocket/tcp", cfg);
}

AFInetDestDriver *
afinet_dd_new_tcp6(gchar *host, GlobalConfig *cfg)
{
  return afinet_dd_new_instance(transport_mapper_tcp6_new(), host, "afsocket/tcp6", cfg);
}

AFInetDestDriver *
afinet_dd_new_udp(gchar *host, GlobalConfig *cfg)
{
  return afinet_dd_new_instance(transport_mapper_udp_new(), host, "afsocket/udp", cfg);
}

AFInetDestDriver *
afinet_dd_new_udp6(gchar *host, GlobalConfig *cfg)
{
  return afinet_dd_new_instance(transport_mapper_udp6_new(), host, "afsocket/udp6", cfg);
}
...
{
  AFInetDestDriver *self = afinet_dd_new_instance(transport_mapper_syslog_new(), host, "afsocket/syslog", cfg);
...
{
  return afinet_dd_new_instance(transport_mapper_network_new(), host, "afsocket/network", cfg);
}
