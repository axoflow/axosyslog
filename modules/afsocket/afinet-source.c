...
{
  return afinet_sd_new_instance(transport_mapper_tcp_new(), "afsocket/tcp", cfg);
}

AFInetSourceDriver *
afinet_sd_new_tcp6(GlobalConfig *cfg)
{
  return afinet_sd_new_instance(transport_mapper_tcp6_new(), "afsocket/tcp6", cfg);
}
...
{
  return afinet_sd_new_instance(transport_mapper_udp_new(), "afsocket/udp", cfg);
}

AFInetSourceDriver *
afinet_sd_new_udp6(GlobalConfig *cfg)
{
  return afinet_sd_new_instance(transport_mapper_udp6_new(), "afsocket/udp6", cfg);
}
...
{
  AFInetSourceDriver *self = afinet_sd_new_instance(transport_mapper_syslog_new(), "afsocket/syslog", cfg);
...
{
  AFInetSourceDriver *self = afinet_sd_new_instance(transport_mapper_network_new(), "afsocket/network", cfg);
  return self;
}
