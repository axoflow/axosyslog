...
Test(basicfuncs, test_numeric_funcs)
{
  ...
  assert_template_format("$(+ 1.5 .25)", "1.75");
  assert_template_format("$(- -1.5 .25)", "-1.75");
  assert_template_format("$(/ 3 2)", "1");
  assert_template_format("$(/ 3.0 2)", "1.5");
  assert_template_format("$(/ 3 2.0)", "1.5");
  assert_template_format("$(* 1.5 2.0)", "3");
  assert_template_format("$(% 3.14 0.7)", "0.3400000000000003");

  assert_template_format("$(+ 5e-1 0)", "0.5");
