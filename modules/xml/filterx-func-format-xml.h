...
gboolean append_to_buffer(FilterXObject *key, FilterXObject *value, gpointer user_data);
...
void append_inner_dict_end_tag(const char *key_str, gpointer user_data);
