...
// This runs during pre_init because acquire queues are running during init
static void
...
diskq_global_metrics_init(void)
{
  ...
  register_application_hook(AH_CONFIG_PRE_INIT, _find_abandoned_disk_buffers_in_default_dir, NULL, AHM_RUN_REPEAT);
