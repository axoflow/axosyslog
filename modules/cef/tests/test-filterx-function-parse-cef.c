...
Test(filterx_func_parse_cef, test_invalid_input)
{
  ...
  cr_assert(eq(str, "Failed to evaluate event format parser: " EVENT_FORMAT_PARSER_ERR_NOT_STRING_INPUT_MSG,
...
Test(filterx_func_parse_cef, test_invalid_version)
{
  ...
  cr_assert(zero(ptr, _eval_input(&init_err, _create_msg_arg(input), NULL)));
  cr_assert(zero(ptr, init_err));
  ...
  cr_assert(eq(str, expected_err_msg->str, last_error));
}
...
Test(filterx_func_parse_cef, test_separate_extensions)
{
  ...
  _assert_parser_result_inner("{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"extensions\":{\"rt\":\"1647626887000\",\"cs9\":\"site location Bldg\",\"cs9Label\":\"GroupName\",\"dhost\":\"WS6465\",\"dst\":\"10.55.203.12\",\"cs2\":\"KES\",\"cs2Label\":\"ProductName\",\"cs3\":\"11.0.0.0\",\"cs3Label\":\"ProductVersion\",\"cs10\":\"Uninstall EDR\",\"cs10Label\":\"TaskName\",\"cs4\":\"885\",\"cs4Label\":\"TaskId\",\"cn2\":\"4\",\"cn2Label\":\"TaskNewState\",\"cn1\":\"0\",\"cn1Label\":\"TaskOldState\"}}",
...
Test(filterx_func_parse_cef, test_empty_header)
{
  _assert_parser_result("CEF:0|KasperskyLab||13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|rt=1647626887000 cs9=site location Bldg cs9Label=GroupName dhost=WS6465 dst=10.55.203.12 cs2=KES cs2Label=ProductName cs3=11.0.0.0 cs3Label=ProductVersion cs10=Uninstall EDR cs10Label=TaskName cs4=885 cs4Label=TaskId cn2=4 cn2Label=TaskNewState cn1=0 cn1Label=TaskOldState",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"rt\":\"1647626887000\",\"cs9\":\"site location Bldg\",\"cs9Label\":\"GroupName\",\"dhost\":\"WS6465\",\"dst\":\"10.55.203.12\",\"cs2\":\"KES\",\"cs2Label\":\"ProductName\",\"cs3\":\"11.0.0.0\",\"cs3Label\":\"ProductVersion\",\"cs10\":\"Uninstall EDR\",\"cs10Label\":\"TaskName\",\"cs4\":\"885\",\"cs4Label\":\"TaskId\",\"cn2\":\"4\",\"cn2Label\":\"TaskNewState\",\"cn1\":\"0\",\"cn1Label\":\"TaskOldState\"}");
}
...
Test(filterx_func_parse_cef, test_extensions_empty)
{
  _assert_parser_result("CEF:0|KasperskyLab|SecurityCenter|13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\"}");
}
...
Test(filterx_func_parse_cef, test_header_escaped_delimiter)
{
  _assert_parser_result("CEF:0|Kaspers\\|kyLab|SecurityCenter|13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|rt=1647626887000",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"Kaspers|kyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"rt\":\"1647626887000\"}");
}
...
Test(filterx_func_parse_cef, test_exteansion_escaped_delimiter)
{
  _assert_parser_result("CEF:0|KasperskyLab|SecurityCenter|13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|escaped=foo\\=bar\\=baz",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"escaped\":\"foo=bar=baz\"}");
}
...
Test(filterx_func_parse_cef, test_extensions_space_in_value)
{
  _assert_parser_result("CEF:0|KasperskyLab|SecurityCenter|13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|foo=bar baz tik=tak toe",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"foo\":\"bar baz\",\"tik\":\"tak toe\"}");
}
...
Test(filterx_func_parse_cef, test_header_whitespaces)
{
  _assert_parser_result("CEF:0|Kasper sky  Lab|SecurityCenter|13.2.0.1511|KLPRCI_TaskState|Completed successfully|1|",
                        "{\"cef_version\":\"0\",\"device_vendor\":\"Kasper sky  Lab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\"}");
}
...
Test(filterx_func_parse_cef, test_forced_pair_separator)
{
  ...
  _assert_parser_result_inner("{\"cef_version\":\"0\",\"device_vendor\":\"KasperskyLab\",\"device_product\":\"SecurityCenter\",\"device_version\":\"13.2.0.1511\",\"device_event_class_id\":\"KLPRCI_TaskState\",\"event_name\":\"Completed successfully\",\"agent_severity\":\"1\",\"foo\":\"bar\",\"bar\":\"baz\",\"baz\":\"tik=tak\"}",
...
Test(filterx_func_parse_cef, test_forced_empty_value_separator)
{
  ...
  cr_assert(eq(str, error->message, expected_err_msg->str));
