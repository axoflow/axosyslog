...
{
  const gchar *input = "LEEF:1.0|Microsoft|MSExchange|4.0 SP1|15345|foo#bar\tbar#baz\tbaz#tiktak";
  _assert_parser_result_inner("{\"leef_version\":\"1.0\",\"vendor_name\":\"Microsoft\",\"product_name\":\"MSExchange\",\"product_version\":\"4.0 SP1\",\"event_id\":\"15345\",\"foo\":\"bar\",\"bar\":\"baz\",\"baz\":\"tiktak\"}",
