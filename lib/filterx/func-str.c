...
typedef gboolean (*FilterXExprAffixProcessFunc)(FilterXExprAffix *self, const gchar *haystack, gsize haystack_len, const gchar *needle,
                                                gsize needle_len);
...
static gboolean
_function_startswith_process(FilterXExprAffix *self, const gchar *haystack, gsize haystack_len, const gchar *needle, gsize needle_len)
{
...
static gboolean
_function_endswith_process(FilterXExprAffix *self, const gchar *haystack, gsize haystack_len, const gchar *needle, gsize needle_len)
{
  if (needle_len > haystack_len)
    return FALSE;
...
static gboolean
_function_includes_process(FilterXExprAffix *self, const gchar *haystack, gsize haystack_len, const gchar *needle, gsize needle_len)
{
