...
{
  cr_assert_null(_eval_binop_double(filterx_operator_division_new, 1.0, 0.0));
}

Test(filterx_expr_arithmetic, double_zero_over_zero_is_rejected)
{
  cr_assert_null(_eval_binop_double(filterx_operator_division_new, 0.0, 0.0));
}

Test(filterx_expr_arithmetic, double_multiplication_overflow_is_rejected)
{
  cr_assert_null(_eval_binop_double(filterx_operator_multiplication_new, 1e308, 1e308));
}

Test(filterx_expr_arithmetic, double_subtraction_overflow_is_rejected)
{
  cr_assert_null(_eval_binop_double(filterx_operator_substraction_new, -1e308, 1e308));
}
