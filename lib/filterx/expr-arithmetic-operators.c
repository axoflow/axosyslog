...
filterx_arithmetic_operator_substraction_new(FilterXExpr *lhs, FilterXExpr *rhs)
{
  ...
  filterx_binary_op_init_instance(&self->super, "subs", FALSE, lhs, rhs);
...
{
  FilterXArithmeticOperator *self = g_new0(FilterXArithmeticOperator, 1);
  filterx_binary_op_init_instance(&self->super, "mult", FALSE, lhs, rhs);
...
{
  FilterXArithmeticOperator *self = g_new0(FilterXArithmeticOperator, 1);
  filterx_binary_op_init_instance(&self->super, "mod", FALSE, lhs, rhs);
...
filterx_arithmetic_operator_uminus_new(FilterXExpr *operand)
{
  ...
  filterx_unary_op_init_instance(self, "uminus", FALSE, operand);
