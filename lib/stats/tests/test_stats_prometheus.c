...
Test(stats_prometheus, test_prometheus_format_value)
{
  ...
  stats_cluster_key_add_unit(&key, SCU_NANOSECONDS);
  ...
  stats_cluster_key_add_frame_of_reference(&key, SCFOR_RELATIVE_TO_TIME_OF_QUERY);
