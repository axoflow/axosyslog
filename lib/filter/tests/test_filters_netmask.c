...
static FilterParamNetmask test_filter_netmask_ip4_socket_params[] =
{
...
StaticParameterizedTest(FilterParamNetmask *param, test_filter_netmask_ip4_socket_params, filter,
                        test_filter_netmask_ip4_socket)
{
  testcase_with_socket(param->msg, param->sockaddr, filter_netmask_new(param->cidr), param->expected_result);
}


static FilterParamNetmask test_filter_netmask_ip4_params[] =
{
...
StaticParameterizedTest(FilterParamNetmask *param, test_filter_netmask_ip4_params, filter, test_filter_netmask_ip4)
{
