...
StaticParameterizedTest(FilterParamRegexp *param, test_filter_regexp_backref_chk_params, filter,
                        test_filter_regexp_backref_chk)
{
...
static FilterParamRegexp test_filter_regexp_filter_params[] =
{
...
StaticParameterizedTest(FilterParamRegexp *param, test_filter_regexp_filter_params, filter, test_filter_regexp_filter)
{
  FilterExprNode *filter = create_pcre_regexp_filter(param->field, param->regexp, param->flags);
  testcase(param->msg, filter, param->expected_result);
}

static FilterParamRegexp test_filter_regexp_filter_fop_params[] =
{
...
StaticParameterizedTest(FilterParamRegexp *param, test_filter_regexp_filter_fop_params, filter,
                        test_filter_regexp_filter_fop)
{
...
static FilterParamRegexp test_filter_regexp_match_fop_params[] =
{
...
StaticParameterizedTest(FilterParamRegexp *param, test_filter_regexp_match_fop_params, filter,
                        test_filter_regexp_match_fop)
{
...
static FilterParamRegexp test_filter_regexp_match_params[] =
{
...
StaticParameterizedTest(FilterParamRegexp *param, test_filter_regexp_match_params, filter, test_filter_regexp_match)
{
