...
static StringValueList test_escaped_binary_params[] =
{
  {"", "", 0, -1},
  {"\n", "\\n", 0, -1},
  {"\b \f \n \r \t", "\\b \\f \\n \\r \\t", 0, -1},
...
StaticParameterizedTest(StringValueList *string_value_list, test_escaped_binary_params, test_utf8utils,
                        test_escaped_binary)
{
...
static StringValueList test_escaped_text_params[] =
{
  {"", "", 0, -1},
  {"\n", "\\n", 0, -1},
  {"\b \f \n \r \t", "\\b \\f \\n \\r \\t", 0, -1},
...
StaticParameterizedTest(StringValueList *string_value_list, test_escaped_text_params, test_utf8utils, test_escaped_text)
{
