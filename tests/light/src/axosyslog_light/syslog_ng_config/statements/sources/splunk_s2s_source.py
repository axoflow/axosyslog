...
# Fed over the wire by a network() destination with the splunk-s2s
# transport, so there is no client-side I/O object to attach.
class SplunkS2SSource(SourceDriver):
    def __init__(
        self,
        ...
        **options,
        ...
        options.setdefault("transport", '"splunk-s2s"')
        super(SplunkS2SSource, self).__init__(stats_handler, prometheus_stats_handler, None, options)
