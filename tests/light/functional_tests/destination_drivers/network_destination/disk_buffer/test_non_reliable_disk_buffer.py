...
#
# NOTE: if this test fails, it probably means that the memory allocation of
# the LogMessage structure has changed.  Maybe you changed the memory layout
# or allocation? Adjust SIZE_OF_MESSAGE_IN_MEMORY in helper_functions.py
#
...
#
# NOTE: if this test fails, it probably means that the serialized size of
# the LogMessage has changed.  Maybe you changed serialization?
# Adjust SIZE_OF_MESSAGE_IN_DISKQ in helper_functions.py
#
