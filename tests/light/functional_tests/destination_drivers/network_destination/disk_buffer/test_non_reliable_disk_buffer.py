...
from helper_functions import set_expected_metrics_state_when_sending_more_logs_than_buffer_can_handle
...
@pytest.mark.parametrize(
    "params", [
        ...
        TCParams(
            # [FrontCache_MAX]-[QDISK_MAX]-[WINDOW_MAX] + 1 message
            loggen_msg_number=1325,
            last_msg_id="0000001324",
            is_suspended_source=True,
            before=BufferState(
                syslogng_disk_queue_processed_events_total=1324,
                syslogng_disk_queue_disk_allocated_bytes=1048576,
            ...
            after=BufferState(
                syslogng_disk_queue_processed_events_total=1325,
                syslogng_disk_queue_disk_allocated_bytes=1048576,
                syslogng_disk_queue_disk_usage_bytes=0,
                syslogng_disk_queue_events=0,
                syslogng_disk_queue_memory_usage_bytes=0,
...
def test_fill_up_buffers_for_non_reliable_disk_buffer_without_flow_control_then_send_out_all_logs(config, port_allocator, syslog_ng, loggen, dqtool):
    ...
    expected_metrics_state = set_expected_metrics_state_when_sending_more_logs_than_buffer_can_handle(frontCache_size, qdisk_size, extra_msg_number)
